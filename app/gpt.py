...
SECRET_KEY="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"

openai.api_key = SECRET_KEY

def get_dictionary(topic, level, max_hours):
    MODEL_NAME = "gpt-3.5-turbo"
    system_msg = "You are a ai learning assistant.  You provide schedules for learning based on a skill/topic chosen by the user. " \
                 f"The topic is {topic} and the level of learning is {level}"
    user_msg = "Please generate a learning schedule in the form of a dictionary. Here are the requirements:" \
